...
nlopt :: (CDouble -> Ptr CDouble -> Ptr CDouble -> CUInt -> FunPtr ((CUInt -> Ptr CDouble -> Ptr CDouble -> Ptr () -> IO CDouble)) -> Ptr CDouble -> Ptr CDouble -> CInt) -> [Double] -> Double ->  [Double] -> ([Double] -> Double) -> [Maybe Double] -> [Maybe Double] -> IO ([Double],Int)
